...
namespace AuthSystem.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<Application> _signInManager;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Application { UserName = Input.Email, Email = Input.Email, FirstName = Input.FirstName, LastName = Input.LastName };
